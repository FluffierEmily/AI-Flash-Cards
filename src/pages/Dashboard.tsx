        ...
        <div className="relative overflow-hidden rounded-3xl border border-border bg-card p-6 sm:p-8 shadow-xs animate-in fade-in slide-in-from-bottom-2 duration-300">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
            <button
              ...
              className="flex items-center justify-center gap-2.5 rounded-2xl bg-secondary/50 border border-border hover:border-primary/40 hover:bg-secondary/80 text-foreground px-6 py-4 text-sm font-semibold transition-all duration-200 active:scale-95 shadow-sm cursor-pointer group shrink-0"
            >
              <Layers className="h-5 w-5 text-primary group-hover:scale-110 transition-transform duration-200" />
